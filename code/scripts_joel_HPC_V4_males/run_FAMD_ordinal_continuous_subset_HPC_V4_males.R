...
multi_morbid=readRDS("../data/processed_V4_males/multi_morbid_ordinal_continuous_HW_mod_no_obesity_male_subset.rds")
...
svg(filename="../results/results_joel_HPC_V4_male/FAMD_ordinal_continuous_subset_multi_morbid_ind_plot_d12.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V4_male/FAMD_ordinal_continuous_subset_multi_morbid_ind_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V4_male/FAMD_ordinal_continuous_subset_multi_morbid_var_plot_d12.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V4_male/FAMD_ordinal_continuous_subset_multi_morbid_var_plot_d34.svg",width=10,height=10)
print(FAMD_multi_morbid_var_plot_d34)
dev.off()


saveRDS(FAMD_multi_morbid_res,"../data/processed_V4_males/FAMD_ordinal_continuous_subset_multi_morbid_res.rds")
