...
saveRDS(gower_diana_multi_morbid,"../results/results_joel_HPC_V3_female/gower_diana/gower_diana_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V3_female/gower_diana/gower_diana_multi_morbid_plot_d12.svg",width=10,height=10)
print(gower_diana_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V3_female/gower_diana/gower_diana_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V3_female/gower_diana/gower_diana_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_female/gower_diana/gower_diana_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_female/gower_diana/gower_diana_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V3_female/gower_diana/",
...
saveRDS(var_importance_df,paste0("../results/results_joel_HPC_V3_female/gower_diana/",
...
if (do_stability==TRUE) {
  ...
  saveRDS(var_importance_stab_df,paste0("../results/results_joel_HPC_V3_female/gower_diana/",
