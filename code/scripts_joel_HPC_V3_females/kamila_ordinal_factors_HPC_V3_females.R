...
FAMD_multi_morbid_res=readRDS("../data/processed_V3_females/FAMD_ordinal_factors_multi_morbid_res.rds")
...
saveRDS(var_importance_df,"../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_var_importance_df_morbid.rds")
...
if (do_stability==TRUE) {
  ...
  saveRDS(var_importance_stab_df,"../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_var_importance_stab_df_morbid.rds")
