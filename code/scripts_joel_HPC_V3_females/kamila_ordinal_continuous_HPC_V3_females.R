...
if (do_choose_nclusters==TRUE) {
  ...
  saveRDS(kamRes,"../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_cluster_choice_multi_morbid.rds")
...
saveRDS(var_importance_df,"../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_var_importance_df_morbid.rds")
...
if (do_stability==TRUE) {
  ...
  saveRDS(var_importance_stab_df,"../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_var_importance_stab_df_morbid.rds")
