...
saveRDS(kamila_multi_morbid,"../results/results_joel_HPC_V4/kamila_ordinal_factors/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V4/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_plot_d34.svg",width=10,height=10)
