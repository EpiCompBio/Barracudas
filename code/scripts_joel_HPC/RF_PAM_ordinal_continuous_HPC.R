...
svg(filename="../results/results_joel_HPC/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(RF_pam_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC/RF_pam_ordinal_continuous/RF_pam_multi_ordinal_continuous_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
