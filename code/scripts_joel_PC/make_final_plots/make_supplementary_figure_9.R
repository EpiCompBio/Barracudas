...
FAMD_kmeans_ordinal_continuous_var_importance_stab_df_female=
  readRDS("../real_results_from_HPC/results_joel_HPC_V3_female/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_var_importance_stab_df_morbid.rds")
...
kamila_var_importance_stab_df_morbid_female=
  readRDS("../real_results_from_HPC/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_var_importance_stab_df_morbid.rds")


variable_importance_stability_plot_1=make_variable_importance_stability_plot(FAMD_kmeans_ordinal_continuous_var_importance_stab_df_female,
...
FAMD_kmeans_ordinal_continuous_var_importance_stab_df_male=
  readRDS("../real_results_from_HPC/results_joel_HPC_V3_male/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_var_importance_stab_df_morbid.rds")
...
kamila_var_importance_stab_df_morbid_male=
  readRDS("../real_results_from_HPC/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_var_importance_stab_df_morbid.rds")


variable_importance_stability_plot_1=make_variable_importance_stability_plot(FAMD_kmeans_ordinal_continuous_var_importance_stab_df_male,
                                                                             grouping_names=grouping_names, color_scale=NULL,custom_theme=theme_jh,
