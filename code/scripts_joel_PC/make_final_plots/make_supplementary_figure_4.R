...
cluster_crit_df_FAMD_kmeans_ordinal_factors_multi_morbid_female=
  readRDS("../real_results_from_HPC/results_used_for_final_figures/supplementary_figure_4/cluster_crit_df_FAMD_kmeans_ordinal_factors_multi_morbid_female.rds")

cluster_crit_df_FAMD_kmeans_ordinal_factors_multi_morbid_male=
  readRDS("../real_results_from_HPC/results_used_for_final_figures/supplementary_figure_4/cluster_crit_df_FAMD_kmeans_ordinal_factors_multi_morbid_male.rds")
