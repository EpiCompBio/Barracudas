...
svg(filename="../results_joel_PC/gower_PAM_self_mixed_data_classes_plot.svg",width=10,height=10)
...
svg(filename="../results_joel_PC/gower_PAM_kamila_mixed_data_classes_plot.svg",width=10,height=10)
