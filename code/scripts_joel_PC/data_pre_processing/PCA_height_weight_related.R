...
saveRDS(PCA_multi_morbid_HW$ind$coord,"../data/processed/PCA_multi_morbid_HW_comp12.rds")
...
saveRDS(multi_morbid_ordinal_continuous,"../data/processed/multi_morbid_ordinal_continuous_HW_PCA.rds")
saveRDS(multi_morbid_ordinal_factors,"../data/processed/multi_morbid_ordinal_factors_HW_PCA.rds")
