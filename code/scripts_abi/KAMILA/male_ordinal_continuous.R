...
multi_morbid <- readRDS("Data/gender_stratified/multi_morbid_male_continuous.rds")
...
pdf("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_cluster_choice.pdf")
...
# k=3
set.seed(1)
kamila_cluster_3 <- kamila(multi_morbid[,1:52], multi_morbid[,53:69], numClust = 3, numInit = 10)
...
pdf("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_cluster_plot_3.pdf")
...
pdf("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_cluster_plot_2.pdf")
...
pdf("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_multi_morbid_mean_by_cluster_continuous_plot_2.pdf",width=10,height=10)
...
pdf("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_multi_morbid_mean_by_cluster_continuous_plot_3.pdf",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_2_cat_distributions_",k,"_",length(cat_variables_split),".pdf"),
      width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_3_cat_distributions_",k,"_",length(cat_variables_split),".pdf"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_oc_2_cont_distributions_",k,"_",length(cont_variables_split),".pdf"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/kamila_oc_3_cont_distributions_",k,"_",length(cont_variables_split),".pdf"),
      width=10,height=10)
...
pdf("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_silhoutte_oc_2_kamila.pdf")
sil_plot_oc_2
dev.off()
...
pdf("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_silhoutte_oc_3_kamila.pdf")
sil_plot_oc_3
dev.off()
...
pdf(paste0("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_ordinal_continuous_multi_morbid_cluster_differences_by_variable.pdf"),
    width=10,height=10)
...
pdf(paste0("Git_Repo/code/results_abi/KAMILA_ordinal_continuous/Male/male_kamila_ordinal_continuous_multi_morbid_variable_importance.pdf"),
    width=10,height=10)
