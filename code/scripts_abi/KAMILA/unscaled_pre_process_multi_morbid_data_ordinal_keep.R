...
#define obese BMI > 35
full_data_unscaled$obese = ifelse(full_data_unscaled$BMI >= 35, 1, 0)
...
#re-organize columns
full_data_unscaled=full_data_unscaled %>% dplyr::select(eid,mi,angina,stroke,obese,diabetes,htn,dvt_asthma_copd_atopy,no_chronic, everything())
...
multi_morbid_unscaled <- multi_morbid_unscaled[ ,-c(1:8)]
...
saveRDS(multi_morbid_unscaled, "Data/multi_morbid_unscaled_ordinal_factors.rds")