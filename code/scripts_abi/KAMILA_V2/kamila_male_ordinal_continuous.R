...
multi_morbid <- readRDS("Data/KAMILA_V2/kamila_multi_morbid_male_continuous.rds")
multi_morbid <- multi_morbid[ ,-65]
...
kamRes <- kamila(multi_morbid[,1:47], multi_morbid[,48:64], numClust = 2:5, numInit = 10,
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_cluster_choice.pdf")
...
# k=3
set.seed(1)
kamila_cluster_3 <- kamila(multi_morbid[,1:47], multi_morbid[,48:64], numClust = 3, numInit = 10)
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_cluster_plot_3.pdf")
kamila_cluster_plot_3
dev.off()

# k=2
set.seed(1)
kamila_cluster_2 <- kamila(multi_morbid[,1:47], multi_morbid[,48:64], numClust = 2, numInit = 10)
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_cluster_plot_2.pdf")
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_multi_morbid_mean_by_cluster_continuous_plot_2.pdf",width=10,height=10)
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_multi_morbid_mean_by_cluster_continuous_plot_3.pdf",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_2_cat_distributions_",k,"_",length(cat_variables_split),".pdf"),
      width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_3_cat_distributions_",k,"_",length(cat_variables_split),".pdf"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_oc_2_cont_distributions_",k,"_",length(cont_variables_split),".pdf"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/kamila_oc_3_cont_distributions_",k,"_",length(cont_variables_split),".pdf"),
      width=10,height=10)
...
mm_unscaled <- readRDS("Data/Unscaled/unscaled_kamila_multi_morbid_continuous.rds")
mm_unscaled <- mm_unscaled[mm_unscaled$Sex == "Male", ]
sil_plot_oc_2 = silhouette_plot_ggplot2(data = mm_unscaled, classes = kamila_cluster_2$finalMemb)

pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_silhoutte_oc_2_kamila.pdf")
sil_plot_oc_2
dev.off()
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_silhoutte_oc_3_kamila.pdf")
sil_plot_oc_3
dev.off()
...
pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_ordinal_continuous_multi_morbid_cluster_differences_by_variable.pdf"),
    width=10,height=10)
...
pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordinal_continuous/Male/male_kamila_ordinal_continuous_multi_morbid_variable_importance.pdf"),
    width=10,height=10)
