...
kamRes <- kamila(multi_morbid[,1:31], multi_morbid[,32:65], numClust = 2:5, numInit = 10,
...
svg("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_cluster_choice.svg")
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_cluster_choice.pdf")
plot(2:5, kamRes$nClust$psValues,
     pch = 19, frame = FALSE, 
     xlab="Number of clusters",
     ylab="Prediction Strength", xlim = c(2, 5), ylim = c(0, 1))
...
# k=3
set.seed(1)
kamila_cluster_3 <- kamila(multi_morbid[,1:31], multi_morbid[,32:65], numClust = 3, numInit = 10)
...
svg("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_cluster_plot_3.svg")
kamila_cluster_plot_3
dev.off()

pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_cluster_plot_3.pdf")
kamila_cluster_plot_3
dev.off()

# k=2
set.seed(1)
kamila_cluster_2 <- kamila(multi_morbid[,1:31], multi_morbid[,32:65], numClust = 2, numInit = 10)
...
svg("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_cluster_plot_2.svg")
kamila_cluster_plot_2
dev.off()

pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_cluster_plot_2.pdf")
kamila_cluster_plot_2
dev.off()
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_multi_morbid_mean_by_cluster_continuous_plot_2.pdf",width=10,height=10)
...
svg(filename="Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_multi_morbid_mean_by_cluster_continuous_plot_3.svg",width=10,height=10)
print(KAMILA_of_3_mean_by_cluster_continuous_plot)
dev.off()

pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_multi_morbid_mean_by_cluster_continuous_plot_3.pdf",width=10,height=10)
print(KAMILA_of_3_mean_by_cluster_continuous_plot)
dev.off()
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_2_cat_distributions_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_2_cat_distributions_",k,"_",length(cat_variables_split),".pdf"),
      width=10,height=10)
  grid.draw(kamila_of_2_cat_distribution_by_cluster)
  dev.off()
}
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_3_cat_distributions_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_3_cat_distributions_",k,"_",length(cat_variables_split),".pdf"),
      width=10,height=10)
  grid.draw(kamila_of_3_cat_distribution_by_cluster)
  dev.off()
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_2_cont_distributions_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_of_2_cont_distributions_",k,"_",length(cont_variables_split),".pdf"),
      width=10,height=10)
  grid.draw(kamila_of_2_cont_distribution_by_cluster)
  dev.off()
}
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_3_cont_distributions_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_3_cont_distributions_",k,"_",length(cont_variables_split),".pdf"),
      width=10,height=10)
  grid.draw(kamila_of_3_cont_distribution_by_cluster)
  dev.off()
}
...
mm_unscaled <- readRDS("Data/KAMILA_V2/Unscaled/unscaled_kamila_multi_morbid_ordinal_keep.rds")
...
pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/silhoutte_of_2_kamila.pdf")
sil_plot_of_2
dev.off()
...
svg("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/silhoutte_of_3_kamila.svg")
sil_plot_of_3
dev.off()

pdf("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/silhoutte_of_3_kamila.pdf")
sil_plot_of_3
dev.off()
...
pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_ordinal_factors_multi_morbid_cluster_differences_by_variable.pdf"),
    width=10,height=10)
...
pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_3_ordinal_factors_multi_morbid_cluster_differences_by_variable.pdf"),
    width=10,height=10)
print(significant_cluster_differences_by_variable_plot)
dev.off()
...
pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_2_ordinal_factors_multi_morbid_variable_importance.pdf"),
    width=10,height=10)
...
pdf(paste0("Git_Repo/code/results_abi/FINAL_KAMILA/ordered_factors/Full_data/kamila_3_ordinal_factors_multi_morbid_variable_importance.pdf"),
    width=10,height=10)
print(variable_importance_plot)
dev.off()