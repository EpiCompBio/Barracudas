...
saveRDS(merged_data,"Data/KAMILA_V2/unscaled_full_data_ordinal_continuous.rds")
saveRDS(multi_morbid,"Data/KAMILA_V2/unscaled_multi_morbid_ordinal_continuous.rds")

##### Scale data ######

for (k in 1:ncol(merged_data)) {
  if (class(merged_data[,k])!="factor" & k!=1) {
    merged_data[,k]=scale(merged_data[,k])
  }
}
...
saveRDS(merged_data,"Data/KAMILA_V2/full_data_ordinal_continuous.rds")
saveRDS(multi_morbid,"Data/KAMILA_V2/multi_morbid_ordinal_continuous.rds")
