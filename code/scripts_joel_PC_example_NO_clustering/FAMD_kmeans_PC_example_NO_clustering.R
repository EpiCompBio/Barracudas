...
if(dir.exists("../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering")==FALSE) {
  dir.create("../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering")
}
...
do_rep_NO_clustering=TRUE

n_rep_choose_nb_clust=10
seed_start_choose_clust=200

n_rep_NO_clustering=50
seed_start_NO_clustering=1000
...
if (do_choose_nclusters==TRUE) {
  ...
  saveRDS(cluster_crit_df,"../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/cluster_crit_df_FAMD_kmeans_example_NO_clustering_multi_morbid.rds")
...
if (do_rep_NO_clustering==TRUE) {
  
  cluster_crit_vector=rep(0,n_rep_NO_clustering)
  
  registerDoParallel(n_Cores)
  
  cluster_crit_vector=unlist(foreach(k=1:n_rep_NO_clustering,
                                     .packages = c('FactoMineR',"randomForest","clusterCrit")) %dopar% {
                                       
                                       
                                       set.seed(seed_start_NO_clustering+k)
  ...
  set.seed(which.max(cluster_crit_vector) + seed_start_NO_clustering)
  FAMD_kmeans_multi_morbid=kmeans(FAMD_multi_morbid_res$ind$coord[,1:nb_comp_FAMD_multi_morbid],centers=3)
...
saveRDS(FAMD_kmeans_multi_morbid,"../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/FAMD_kmeans_example_NO_clustering_multi_morbid.rds")
...
svg(filename="../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/FAMD_kmeans_example_NO_clustering_multi_morbid_plot_d12.svg",width=10,height=10)
print(FAMD_kmeans_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/FAMD_kmeans_example_NO_clustering_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/FAMD_kmeans_example_NO_clustering_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/FAMD_kmeans_example_NO_clustering_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/FAMD_kmeans_example_NO_clustering_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/",
                    "FAMD_kmeans_example_NO_clustering_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
...
svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/",
                    "FAMD_kmeans_example_NO_clustering_multi_morbid_variable_importance.svg"),
    width=10,height=10)
...
svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/FAMD_kmeans_example_NO_clustering/",
                    "FAMD_kmeans_example_NO_clustering_multi_morbid_variable_importance_stability.svg"),
    width=10,height=10)
