...
using("FactoMineR","ggplot2","ggrepel","viridis","RColorBrewer","reshape2","magrittr",
      "gridExtra","grid","dplyr","parallel","clusterCrit","randomForest","kamila","doParallel")
...
source("../data/processed_example_NO_clustering/var_groupings_example_NO_clustering.R")
...
if(dir.exists("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering")==FALSE) {
  dir.create("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering")
}
...
FAMD_multi_morbid_res=readRDS("../data/processed_example_NO_clustering/FAMD_example_NO_clustering_res.rds")
...
if (do_choose_nclusters==TRUE) {
  ...
  cat_variables_kamila=colnames(multi_morbid)[sapply(multi_morbid,class) == "factor"]
  cont_variables_kamila=colnames(multi_morbid)[sapply(multi_morbid,class) != "factor"]
  ...
  svg("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/kamila_oc_cluster_choice.svg")
...
saveRDS(kamila_multi_morbid,"../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/kamila_example_NO_clustering_multi_morbid_plot_d12.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/kamila_example_NO_clustering_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/kamila_example_NO_clustering_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/kamila_example_NO_clustering_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/kamila_example_NO_clustering_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/",
                    "kamila_example_NO_clustering_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
...
randomForest_multi_morbid=randomForest(multi_morbid, y=as.factor(clusters_kamila_multi_morbid),ntree=500)
...
svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/",
                    "kamila_example_NO_clustering_multi_morbid_variable_importance.svg"),
    width=10,height=10)
...
if (do_stability==TRUE) {
  ...
  var_importance_stab_list=foreach(i=1:n_sub_sample,
                                   .packages = c('kamila',"randomForest","clusterCrit")) %dopar% {
                                     ...
                                     # multi_morbid_subsample= multi_morbid_subsample[,c(2,1,3:ncol(multi_morbid_subsample))]
  ...
  svg(filename=paste0("../results/results_joel_PC_example_NO_clustering/kamila_example_NO_clustering/",
                      "kamila_example_NO_clustering_multi_morbid_variable_importance_stability.svg"),
      width=10,height=10)
