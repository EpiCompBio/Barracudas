...
if(dir.exists("../results/results_joel_PC_example_clustering/kamila_example_clustering")==FALSE) {
  dir.create("../results/results_joel_PC_example_clustering/kamila_example_clustering")
}
...
svg("../results/results_joel_PC_example_clustering/kamila_example_clustering/kamila_oc_cluster_choice.svg")
...
saveRDS(kamila_multi_morbid,"../results/results_joel_PC_example_clustering/kamila_example_clustering/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_PC_example_clustering/kamila_example_clustering/kamila_example_clustering_multi_morbid_plot_d12.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_PC_example_clustering/kamila_example_clustering/kamila_example_clustering_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_PC_example_clustering/kamila_example_clustering/kamila_example_clustering_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_PC_example_clustering/kamila_example_clustering/kamila_example_clustering_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_PC_example_clustering/kamila_example_clustering/kamila_example_clustering_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_PC_example_clustering/kamila_example_clustering/",
                    "kamila_example_clustering_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
...
svg(filename=paste0("../results/results_joel_PC_example_clustering/kamila_example_clustering/",
                    "kamila_example_clustering_multi_morbid_variable_importance.svg"),
    width=10,height=10)
...
svg(filename=paste0("../results/results_joel_PC_example_clustering/kamila_example_clustering/",
                    "kamila_example_clustering_multi_morbid_variable_importance_stability.svg"),
    width=10,height=10)
