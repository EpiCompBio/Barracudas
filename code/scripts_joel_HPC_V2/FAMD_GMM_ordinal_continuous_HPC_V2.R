...
# }
# 
# using("FactoMineR","ggplot2","ggrepel","viridis","RColorBrewer","reshape2",
#       "magrittr","gridExtra","grid","dplyr","parallel","clusterCrit","mclust","randomForest","doParallel")
...
if (do_choose_nclusters==TRUE) {
  ...
  saveRDS(cluster_crit_df,"../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/cluster_crit_df_FAMD_GMM_ordinal_continuous_multi_morbid.rds")
...
saveRDS(FAMD_GMM_multi_morbid,"../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/FAMD_GMM_ordinal_continuous_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/FAMD_GMM_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(FAMD_GMM_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/FAMD_GMM_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/FAMD_GMM_ordinal_continuous_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/FAMD_GMM_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/FAMD_GMM_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:nrow(distribution_test_df)) {
  ...
  if (distribution_test_df[k,2]=="Cont") {
    ...
    anova_res=summary(lm(outcome ~ clusters,
                         data=data.frame(outcome=multi_morbid[,distribution_test_df[k,1]],clusters=as.factor(clusters_FAMD_GMM_multi_morbid))))
    ...
    distribution_test_df[k,3]=chisq.test(multi_morbid[,distribution_test_df[k,1]],as.factor(clusters_FAMD_GMM_multi_morbid))$p.value
...
svg(filename=paste0("../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/",
                    "FAMD_GMM_ordinal_continuous_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
...
randomForest_multi_morbid=randomForest(multi_morbid[,2:ncol(multi_morbid)], y=as.factor(clusters_FAMD_GMM_multi_morbid),ntree=500)
...
svg(filename=paste0("../results/results_joel_HPC_V2/FAMD_GMM_ordinal_continuous/",
                    "FAMD_GMM_ordinal_continuous_multi_morbid_variable_importance.svg"),
    width=10,height=10)
