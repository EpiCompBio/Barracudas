...
RF_proximity_measure_multi_morbid_res=readRDS("../data/processed_V2/RF_proximity_measure_ordinal_continuous_multi_morbid_male_res.rds")
...
saveRDS(RF_pam_multi_morbid,"../results/results_joel_HPC_V2_male/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V2_male/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(RF_pam_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V2_male/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V2_male/RF_pam_ordinal_continuous/RF_pam_multi_ordinal_continuous_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_male/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_male/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V2_male/RF_PAM_ordinal_continuous/",
...
RF_proximity_measure_multi_morbid_res=readRDS("../data/processed_V2/RF_proximity_measure_ordinal_continuous_multi_morbid_female_res.rds")
...
saveRDS(RF_pam_multi_morbid,"../results/results_joel_HPC_V2_female/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V2_female/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(RF_pam_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V2_female/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
print(RF_pam_multi_morbid_plot_d34)
dev.off()
...
svg(filename="../results/results_joel_HPC_V2_female/RF_pam_ordinal_continuous/RF_pam_multi_ordinal_continuous_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
print(RF_pam_mean_by_cluster_continuous_plot)
dev.off()
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_female/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
  grid.draw(RF_pam_cat_distribution_by_cluster)
  dev.off()
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_female/RF_pam_ordinal_continuous/RF_pam_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
  grid.draw(RF_pam_cont_distribution_by_cluster)
  dev.off()
