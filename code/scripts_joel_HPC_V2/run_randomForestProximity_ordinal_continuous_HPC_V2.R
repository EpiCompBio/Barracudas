...
saveRDS(RF_proximity_measure_multi_morbid_res,"../data/processed_V2/RF_proximity_measure_ordinal_continuous_multi_morbid_male_res.rds")
...
saveRDS(RF_proximity_measure_multi_morbid_res,"../data/processed_V2/RF_proximity_measure_ordinal_continuous_multi_morbid_female_res.rds")
