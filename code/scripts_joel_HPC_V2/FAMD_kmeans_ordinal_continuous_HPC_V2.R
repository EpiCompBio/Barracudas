...
FAMD_multi_morbid_res=readRDS("../data/processed_V2/FAMD_ordinal_continuous_multi_morbid_male_res.rds")
...
saveRDS(cluster_crit_df,
        "../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/cluster_crit_df_FAMD_kmeans_ordinal_continuous_multi_morbid.rds")
...
# FAMD_kmeans_multi_morbid=readRDS("../results/results_joel_HPC_V2_male/FAMD_kmeans/FAMD_kmeans_multi_morbid.rds")


saveRDS(FAMD_kmeans_multi_morbid,
        "../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(FAMD_kmeans_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V2_male/FAMD_kmeans_ordinal_continuous/",
...
FAMD_multi_morbid_res=readRDS("../data/processed_V2/FAMD_ordinal_continuous_multi_morbid_female_res.rds")
...
saveRDS(cluster_crit_df,"../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/cluster_crit_df_FAMD_kmeans_ordinal_continuous_multi_morbid.rds")
...
FAMD_kmeans_multi_morbid=kmeans(FAMD_multi_morbid_res$ind$coord[,1:nb_comp_FAMD_multi_morbid],centers=2)
# FAMD_kmeans_multi_morbid=readRDS("../results/results_joel_HPC_V2_female/FAMD_kmeans/FAMD_kmeans_multi_morbid.rds")


saveRDS(FAMD_kmeans_multi_morbid,"../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(FAMD_kmeans_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
print(FAMD_kmeans_multi_morbid_plot_d34)
dev.off()
...
svg(filename="../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
print(FAMD_kmeans_mean_by_cluster_continuous_plot)
dev.off()
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
  grid.draw(FAMD_kmeans_cat_distribution_by_cluster)
  dev.off()
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/FAMD_kmeans_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
  grid.draw(FAMD_kmeans_cont_distribution_by_cluster)
  dev.off()
...
svg(filename=paste0("../results/results_joel_HPC_V2_female/FAMD_kmeans_ordinal_continuous/",
                    "FAMD_kmeans_ordinal_continuous_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
print(significant_cluster_differences_by_variable_plot)
dev.off()
