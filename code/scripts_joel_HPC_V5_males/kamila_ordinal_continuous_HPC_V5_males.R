...
multi_morbid=readRDS("../data/processed_V5_males/multi_morbid_ordinal_continuous_HW_mod_controls_male.rds")
# multi_morbid=multi_morbid[1:200,]


source("../data/processed_V5_males/var_groupings_V5.R")
...
FAMD_multi_morbid_res=readRDS("../data/processed_V5_males/FAMD_ordinal_continuous_multi_morbid_res.rds")
...
if (do_choose_nclusters==TRUE) {
  ...
  saveRDS(kamRes,"../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_cluster_choice_multi_morbid.rds")
  ...
  svg("../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_oc_cluster_choice.svg")
...
saveRDS(kamila_multi_morbid,"../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/",
...
saveRDS(var_importance_df,"../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_var_importance_df_morbid.rds")
...
if (do_stability==TRUE) {
  ...
  saveRDS(var_importance_stab_df,"../results/results_joel_HPC_V5_male/kamila_ordinal_continuous/kamila_var_importance_stab_df_morbid.rds")
