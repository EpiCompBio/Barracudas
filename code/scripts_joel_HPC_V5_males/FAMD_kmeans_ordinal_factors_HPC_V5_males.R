...
if (do_choose_nclusters==TRUE) {
  ...
  saveRDS(cluster_crit_df,"../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/cluster_crit_df_FAMD_kmeans_ordinal_factors_multi_morbid.rds")
...
saveRDS(FAMD_kmeans_multi_morbid,"../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/FAMD_kmeans_ordinal_factors_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/FAMD_kmeans_ordinal_factors_multi_morbid_plot_d12.svg",width=10,height=10)
print(FAMD_kmeans_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/FAMD_kmeans_ordinal_factors_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/FAMD_kmeans_ordinal_factors_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/FAMD_kmeans_ordinal_factors_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/FAMD_kmeans_ordinal_factors_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/",
...
saveRDS(var_importance_df,paste0("../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/",
...
if (do_stability==TRUE) {
  ...
  saveRDS(var_importance_stab_df,paste0("../results/results_joel_HPC_V5_male/FAMD_kmeans_ordinal_factors/",
