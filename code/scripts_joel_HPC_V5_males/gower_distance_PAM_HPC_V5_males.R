...
multi_morbid=readRDS("../data/processed_V5_males/multi_morbid_ordinal_factors_HW_mod_controls_male_subset.rds")
...
FAMD_multi_morbid_res=readRDS("../data/processed_V5_males/FAMD_ordinal_factors_subset_multi_morbid_res.rds")
...
gower_dissimilarity_multi_morbid_res=readRDS("../data/processed_V5_males/gower_dissimilarity_multi_morbid_res.rds")
...
saveRDS(gower_pam_multi_morbid,"../results/results_joel_HPC_V5_male/gower_pam/gower_pam_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V5_male/gower_pam/gower_pam_multi_morbid_plot_d12.svg",width=10,height=10)
print(gower_pam_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V5_male/gower_pam/gower_pam_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V5_male/gower_pam/gower_pam_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V5_male/gower_pam/gower_pam_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V5_male/gower_pam/gower_pam_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V5_male/gower_pam/",
...
saveRDS(var_importance_df,paste0("../results/results_joel_HPC_V5_male/gower_pam/",
...
if (do_stability==TRUE) {
  ...
  saveRDS(var_importance_stab_df,paste0("../results/results_joel_HPC_V5_male/gower_pam/",
