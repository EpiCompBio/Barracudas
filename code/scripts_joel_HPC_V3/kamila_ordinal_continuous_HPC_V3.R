...
FAMD_multi_morbid_res=readRDS("../data/processed_V3/FAMD_ordinal_continuous_multi_morbid_male_res.rds")
...
################################################################################
# Choosing the number of clusters for kamila
################################################################################


cat_variables_kamila=colnames(multi_morbid[,16:ncol(multi_morbid)])[sapply(multi_morbid[,16:ncol(multi_morbid)],class) == "factor"]
cont_variables_kamila=colnames(multi_morbid[,16:ncol(multi_morbid)])[sapply(multi_morbid[,16:ncol(multi_morbid)],class) != "factor"]
...
svg("../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_oc_cluster_choice.svg")
...
saveRDS(kamila_multi_morbid,"../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d34)
dev.off()
...
svg(filename="../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:nrow(distribution_test_df)) {
  ...
  if (distribution_test_df[k,2]=="Cont") {
    ...
    anova_res=summary(lm(outcome ~ clusters,
                         data=data.frame(outcome=multi_morbid[,distribution_test_df[k,1]],clusters=as.factor(clusters_kamila_multi_morbid))))
    ...
    distribution_test_df[k,3]=chisq.test(multi_morbid[,distribution_test_df[k,1]],as.factor(clusters_kamila_multi_morbid))$p.value
...
svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/",
                    "kamila_ordinal_continuous_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
...
randomForest_multi_morbid=randomForest(multi_morbid[,2:ncol(multi_morbid)], y=as.factor(clusters_kamila_multi_morbid),ntree=500)
...
svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_continuous/",
                    "kamila_ordinal_continuous_multi_morbid_variable_importance.svg"),
    width=10,height=10)
...
FAMD_multi_morbid_res=readRDS("../data/processed_V3/FAMD_ordinal_continuous_multi_morbid_female_res.rds")
...
svg("../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_oc_cluster_choice.svg")
plot(2:5, kamRes$nClust$psValues,
     pch = 19, frame = FALSE, 
     xlab="Number of clusters",
     ylab="Prediction Strength", xlim = c(2, 5), ylim = c(0, 1))
...
saveRDS(kamila_multi_morbid,"../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_plot_d12.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_plot_d34.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d34)
dev.off()
...
svg(filename="../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
print(kamila_mean_by_cluster_continuous_plot)
dev.off()
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
  grid.draw(kamila_cat_distribution_by_cluster)
  dev.off()
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/kamila_ordinal_continuous_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
  grid.draw(kamila_cont_distribution_by_cluster)
  dev.off()
...
svg(filename=paste0("../results/results_joel_HPC_V3_female/kamila_ordinal_continuous/",
                    "kamila_ordinal_continuous_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
print(significant_cluster_differences_by_variable_plot)
dev.off()
