...
svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_multi_morbid_ind_plot_d12.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_multi_morbid_ind_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_multi_morbid_var_plot_d12.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_multi_morbid_var_plot_d34.svg",width=10,height=10)
print(FAMD_multi_morbid_var_plot_d34)
dev.off()


saveRDS(FAMD_multi_morbid_res,"../data/processed_V3/FAMD_ordinal_factors_multi_morbid_male_res.rds")
...
#                                                custom_theme=theme_jh,color_scale=distinct_scale[2],show_labels = FALSE)
# 
# svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_full_data_ind_plot_d12.svg",width=10,height=10)
...
#                                                custom_theme=theme_jh,color_scale=distinct_scale[2],show_labels = FALSE)
# 
# svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_full_data_ind_plot_d34.svg",width=10,height=10)
...
# 
# 
# svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_full_data_var_plot_d12.svg",width=10,height=10)
...
# 
# svg(filename="../results/results_joel_HPC_V3_male/FAMD_ordinal_factors_full_data_var_plot_d34.svg",width=10,height=10)
...
saveRDS(FAMD_multi_morbid_res,"../data/processed_V3/FAMD_ordinal_factors_multi_morbid_female_res.rds")
...
#                                                custom_theme=theme_jh,color_scale=distinct_scale[2],show_labels = FALSE)
# 
# svg(filename="../results/results_joel_HPC_V3_female/FAMD_ordinal_factors_full_data_ind_plot_d12.svg",width=10,height=10)
# print(FAMD_full_data_ind_plot_d12)
# dev.off()
# 
# 
...
#                                                custom_theme=theme_jh,color_scale=distinct_scale[2],show_labels = FALSE)
# 
# svg(filename="../results/results_joel_HPC_V3_female/FAMD_ordinal_factors_full_data_ind_plot_d34.svg",width=10,height=10)
# print(FAMD_full_data_ind_plot_d34)
# dev.off()
# 
# 
...
# 
# 
# svg(filename="../results/results_joel_HPC_V3_female/FAMD_ordinal_factors_full_data_var_plot_d12.svg",width=10,height=10)
# print(FAMD_full_data_var_plot_d12)
# dev.off()
# 
# 
# FAMD_full_data_var_plot_d34 <- make_FAMD_variable_graph(FAMD_full_data_res,dims=c(3,4),custom_theme=theme_jh,color_scale=distinct_scale[2])
# 
# svg(filename="../results/results_joel_HPC_V3_female/FAMD_ordinal_factors_full_data_var_plot_d34.svg",width=10,height=10)
# print(FAMD_full_data_var_plot_d34)
# dev.off()
# 
# 
