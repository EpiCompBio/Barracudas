...
multi_morbid=readRDS("../data/processed_V3/multi_morbid_ordinal_factors_HW_mod_male.rds")
# multi_morbid=multi_morbid[1:200,]



source("../data/processed_V3_V3/var_groupings_V3.R")
...
FAMD_multi_morbid_res=readRDS("../data/processed_V3/FAMD_ordinal_factors_multi_morbid_male_res.rds")
...
svg("../results/results_joel_HPC_V3_male/kamila_ordinal_factors/kamila_oc_cluster_choice.svg")
...
saveRDS(kamila_multi_morbid,"../results/results_joel_HPC_V3_male/kamila_ordinal_factors/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V3_male/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_plot_d12.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V3_male/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_plot_d34.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V3_male/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_factors/",
                    "kamila_ordinal_factors_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
...
svg(filename=paste0("../results/results_joel_HPC_V3_male/kamila_ordinal_factors/",
                    "kamila_ordinal_factors_multi_morbid_variable_importance.svg"),
    width=10,height=10)
...
FAMD_multi_morbid_res=readRDS("../data/processed_V3/FAMD_ordinal_factors_multi_morbid_female_res.rds")
...
svg("../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_oc_cluster_choice.svg")
plot(2:5, kamRes$nClust$psValues,
     pch = 19, frame = FALSE, 
     xlab="Number of clusters",
     ylab="Prediction Strength", xlim = c(2, 5), ylim = c(0, 1))
...
saveRDS(kamila_multi_morbid,"../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_kamila_multi_morbid.rds")
...
svg(filename="../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_plot_d12.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d12)
dev.off()

svg(filename="../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_plot_d34.svg",width=10,height=10)
print(kamila_multi_morbid_plot_d34)
dev.off()
...
svg(filename="../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_mean_by_cluster_continuous_plot.svg",width=10,height=10)
print(kamila_mean_by_cluster_continuous_plot)
dev.off()
...
for (k in 1:length(cat_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_cat_distribution_by_cluster_",k,"_",length(cat_variables_split),".svg"),
      width=10,height=10)
  grid.draw(kamila_cat_distribution_by_cluster)
  dev.off()
...
for (k in 1:length(cont_variables_split)) {
  ...
  svg(filename=paste0("../results/results_joel_HPC_V3_female/kamila_ordinal_factors/kamila_ordinal_factors_multi_morbid_cont_distribution_by_cluster_",k,"_",length(cont_variables_split),".svg"),
      width=10,height=10)
  grid.draw(kamila_cont_distribution_by_cluster)
  dev.off()
...
svg(filename=paste0("../results/results_joel_HPC_V3_female/kamila_ordinal_factors/",
                    "kamila_ordinal_factors_multi_morbid_cluster_differences_by_variable.svg"),
    width=10,height=10)
print(significant_cluster_differences_by_variable_plot)
dev.off()
