...
svg(filename="../results/results_joel_HPC_V4/FAMD_ordinal_continuous_multi_morbid_ind_plot_d12_subset.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V4/FAMD_ordinal_continuous_multi_morbid_ind_plot_d34_subset.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V4/FAMD_ordinal_continuous_multi_morbid_var_plot_d12_subset.svg",width=10,height=10)
...
svg(filename="../results/results_joel_HPC_V4/FAMD_ordinal_continuous_multi_morbid_var_plot_d34_subset.svg",width=10,height=10)
print(FAMD_multi_morbid_var_plot_d34)
dev.off()


saveRDS(FAMD_multi_morbid_res,"../data/processed_V4/FAMD_ordinal_continuous_multi_morbid_res_subset.rds")
