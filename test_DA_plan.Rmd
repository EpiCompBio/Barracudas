...
```{r barracuda, echo=FALSE, fig.align='center'}
knitr::include_graphics("Barracuda.png")
...
tableone = read.csv('descriptive_analysis/tableone.csv')
colnames(tableone) = c('',
                       'Female: 2 diseases',
                       'Male: 2 diseases',
                       'Female: 3 diseases',
                       'Male: 3 diseases',
                       'P value')
knitr::kable(tableone, caption = "Descriptive analysis table")
```

  * Plot distributions of diseases across important epidemiological factors
  
```{r descriptive plots, echo=FALSE}
knitr::include_graphics("plots/birth_years.png")
knitr::include_graphics("plots/BMI.png")
knitr::include_graphics("plots/alcohol.png")
knitr::include_graphics("plots/smoker.png")
```
